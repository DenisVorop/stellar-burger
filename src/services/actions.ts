...
export const login = createAsyncThunk('auth/login', async ({ email, password }: TLoginData) => {
...
export const checkUserAuth = createAsyncThunk('auth/check', async (_, { dispatch }) => {
...
export const register = createAsyncThunk('auth/register', async ({ email, password, name }: TRegisterData) => {
...
export const orderByNumber = createAsyncThunk('feeds/getByNumber', async (data: number) => {
    const res = await getOrderByNumberApi(data);
    return res.orders;
});

export const orderBurger = createAsyncThunk('order/burger', async (data: string[]) => {
